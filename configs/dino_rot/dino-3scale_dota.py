...
model = dict(
    type='Rot_DINO',
    num_queries=1500,  # num_matching_queries
    ...
    decoder=dict(
        ...
        layer_cfg=dict(
            ...
            cross_attn_cfg=dict(
                ...
                num_levels=nums_of_level,
                dropout=0.0,
                use_rot=True),  # 0.1 for DeformDETR
            ffn_cfg=dict(
                embed_dims=256,
                feedforward_channels=2048,  # 1024 for DeformDETR
                ffn_drop=0.0)),  # 0.1 for DeformDETR
    ...
    dn_cfg=dict(  # TODO: Move to model.train_cfg ?
        ...
        group_cfg=dict(dynamic=True, num_groups=3,
                       num_dn_queries=600)),  # TODO: half num_dn_queries
...
train_dataloader = dict(batch_size=2, dataset=dict(data_root=data_root))
