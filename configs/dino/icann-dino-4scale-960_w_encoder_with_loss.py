...
# ]
# anchors = [[(13, 16), (18, 38), (39, 27)], [(31, 64), (70, 50), (53, 106)], [(126, 89), (89, 173), (226, 161)],
#            [(150, 292), (313, 373), (642, 550)]]
anchors = [[(14, 20), (33, 30), (28, 70)], [(72, 51), (64, 114), (135, 102)], [(105, 225), (227, 198), (178, 406)],
           [(327, 461), (554, 285), (693, 594)]]
...
model = dict(
    ...
    rpn_head=dict(
        type='ICANN_Rpn_Head',
        head_module=dict(type='YOLOv7p6HeadModule',
                         num_classes=num_classes,
                        #  in_channels=[256, 512, 768, 1024],
                         in_channels=[128, 256, 384, 512],
        ...
        test_cfg=dict(
            ...
            nms_pre=30000,
            score_thr=0.0,  # Threshold to filter out boxes.
