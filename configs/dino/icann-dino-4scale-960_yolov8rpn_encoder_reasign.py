_base_ = ['./icann-dino-4scale-960_w_encoder_with_loss_latter.py']
base_lr = 0.0001
model = dict(latter=True,
             use_rpn=True,
             ...
             rpn_head=dict(_delete_=True,
                           ...
                           prior_generator=dict(type='mmdet.MlvlPointGenerator', offset=0.5, strides=[8, 16, 32, 64]),
                           ...
                           loss_bbox=dict(type='IoULossYolo',
                                          ...
                                          loss_weight=7.5,
                                          return_iou=False),
                           loss_dfl=dict(type='mmdet.DistributionFocalLoss', reduction='mean', loss_weight=0.375)),
             neck=dict(_delete_=True,
                       ...
                       num_outs=4,
                       return_tuple=True),
             dn_cfg=dict(rpn_noise_flag=True, group_cfg=dict(dynamic=False, num_groups=1, num_dn_queries=100)))
# optimizer
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
