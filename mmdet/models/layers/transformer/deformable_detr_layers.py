...
from .multi_scale_deform_attn import MultiScaleDeformableAttention, multi_scale_deformable_attn_pytorch, MultiScaleDeformableAttnFunction
...
class MultiScaleRotDeformableAttention(MultiScaleDeformableAttention):
...
class DeformableDetrTransformerEncoderLayer(DetrTransformerEncoderLayer):
    ...
    def _init_layers(self) -> None:
        ...
        if self.self_attn_cfg.pop('use_rot', False):
            self.self_attn = MultiScaleRotDeformableAttention(
                **self.self_attn_cfg)
        else:
...
class DeformableDetrTransformerDecoderLayer(DetrTransformerDecoderLayer):
    ...
    def _init_layers(self) -> None:
        ...
        if self.cross_attn_cfg.pop('use_rot', False):
            self.cross_attn = MultiScaleRotDeformableAttention(
                **self.cross_attn_cfg)
        else:
